...
INSERT INTO public.usuario_javeriana(dtype, apellidos, estado_enum, nombre, password, username, administrador,email)VALUES ('Estudiante','Gaitan Bautista','NUEVO','Pablo','123456','pGaitan',false,'d-sancheza@javeriana.edu.co');
INSERT INTO public.usuario_javeriana(dtype, apellidos, estado_enum, nombre, password, username, administrador,email)VALUES ('Estudiante','Velasco Zambrano','NUEVO','David','123456','dVelazco',false,'d-sancheza@javeriana.edu.co');
...
INSERT INTO public.evento( dtype, descripcion, fin, inicio, requisitos, titulo, creador_id,capacidad_maxima) VALUES ('Actividad', 'El Centro Ático, la Facultad de Ingeniería, la Facultad de Estudios Ambientales y Rurales de la Pontificia Universidad Javeriana y el EL TIEMPO Casa Editorial, invitan a participar en la Hackathón “Reinventa, Realiza y Respira” que tiene como fin promover el encuentro, la experimentación y la creación interdisciplinar entre los participantes, quienes durante 24 horas continuas resolverán el reto propuesto para el encuentro. Con el apoyo de la Vicerrectoría del Medio Universitario y la Vicerrectoría Académica, de la Pontificia Universidad Javeriana','2018-05-12', '2018-05-11', 'Los participantes deberán tener vigente su matrícula universitaria', 'Hackaton', 2,120);
