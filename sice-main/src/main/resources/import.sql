...
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDAD',true,'Pontificia Universidad Javeriana', 'http://www.javeriana.edu.co/vicerrectoria-academica/emprendimiento',true, 'UniversidadJaveriana.png');
...
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDAD',true,'Universidad Rafael Landívar', 'https://emprendedoresurl.wordpress.com/tag/universidad-rafael-landivar/',true, 'UniversidadRafaelLandivar.jpg');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDAD',true,'Universidad Centroamericana José Simeón Cañas', 'http://www.uca.edu.sv/noticias/texto-222',true, 'UniversidadCentroamericana.jpg');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDAD',true,'Universidad Alberto Hurtado', 'http://www.uahurtado.cl/2009/09/emprendimiento-e-innovaci%E2%80%94n-en-la-uah/',true, 'UniversidadHurtado.jpg');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDAD',true,'Universidad Iberoamericana León', 'https://www.leon.uia.mx/noticias/articulo.cfm?Liga=Ideas-de-negocio-Ibero-Emprende-2016',true, 'UniversidadIberoamericana.jpg');
...
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDAD',true,'Universidad Centroamericana UCA', 'http://www.uca.edu.ni/2/index.php/programa-emprende',true, 'UniversidadUCA.jpg');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDAD',true,'Universidad Antonio Ruiz de Montoya', 'https://www.uarm.edu.pe/Agenda/I-coloquio-estudiantes-administracion-emprendimiento-innovacion-tecnologica#.Wsrh7IhubIU',true, 'UniversidadAntonio.jpg');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDAD',true,'Universidad Católica Andrés Bello', 'http://w2.ucab.edu.ve/emprendedores.html',true, 'UniversidadCatolicaAndres.jpg');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDAD',true,'Jesuitas Centro Loyola', 'http://centroloyola.com.ar/agenda/',true, 'JesuitasCentroLoyola.png');
...
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDAD',false,'Universidad Católica del Táchira', 'http://www.tachiranews.com/curso-de-creadores-de-empresas-ofrece-la-alcaldia-y-ucat/',true, 'UniversidadTachira.jpg');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDAD',false,'Universidad del Pacífico (Perú)', 'http://emprendeup.pe/',true, 'UniversidadPacifico.png');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDAD',false,'Universidad Católica de Uruguay', 'https://ucu.edu.uy/es/la-fuerza-de-la-innovacion-y-el-emprendimiento',true, 'UniversidadCatolicaUruguay.png');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDAD',false,'Pontificia Universidad Católica del Ecuador', 'http://repositorio.puce.edu.ec/handle/22000/9212',true, 'UniversidadCatolicaEcuador.jpg');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDAD',false,'University of Utah', 'http://eccles.utah.edu/faculty/department-entrepreneurship-strategy/',true, 'UniversidadDistrital.png');
...
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDAD',false,'La Universidad de Vale do Rio dos Sinos (Unisinos)', 'http://www.unisinos.br/portal-de-inovacao/',true, 'UniversidadDeVale.jpg');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDAD',false,'Pontifícia Universidade Católica do Rio de Janeiro', 'http://nupem.iag.puc-rio.br/',true, 'UniversidadRioJaneiro.png');
...
----------------------------------INSERTS EVENTOS ----------------------------------
INSERT INTO public.evento( dtype, descripcion, fin, inicio, requisitos, titulo, creador_id) VALUES ('Actividad', 'Evento que pone a prueba tus habilidades de programador, ¡anímate a participar!','2018-04-04', '2018-04-04', 'Esta actividad no tiene ningún requisito', 'Maratón de Programación', 2);
INSERT INTO public.evento( dtype, descripcion, fin, inicio, requisitos, titulo, creador_id) VALUES ('Actividad', 'Evento que pone a prueba tus habilidades de trabajo en equipo y de programación, ¡anímate a participar!','2018-04-10', '2018-04-08', 'Esta actividad no tiene ningún requisito', 'HACKATON 2018', 2);
INSERT INTO public.evento( dtype, descripcion, fin, inicio, requisitos, titulo, creador_id) VALUES ('Actividad', 'Evento de prueba, ¡anímate a participar!','2018-04-11', '2018-04-08', 'Esta actividad no tiene ningún requisito', 'Charla motivacional de emprendedores 2018', 2);
INSERT INTO public.evento( dtype, descripcion, fin, inicio, requisitos, titulo, creador_id) VALUES ('Actividad', 'Evento de prueba, ¡anímate a participar!','2018-04-14', '2018-04-14', 'Esta actividad no tiene ningún requisito', 'Conferencia Emprende Más', 2);
INSERT INTO public.evento( dtype, descripcion, fin, inicio, requisitos, titulo, creador_id) VALUES ('Actividad', 'Evento de prueba, ¡anímate a participar!','2018-04-17', '2018-04-15', 'Esta actividad no tiene ningún requisito', 'Google Conference', 2);
INSERT INTO public.evento( dtype, descripcion, fin, inicio, requisitos, titulo, creador_id) VALUES ('Actividad', 'Evento de prueba, ¡anímate a participar!','2018-04-22', '2018-04-20', 'Esta actividad no tiene ningún requisito', 'Microsoft en la Javeriana', 2);
INSERT INTO public.evento( dtype, descripcion, fin, inicio, requisitos, titulo, creador_id) VALUES ('Actividad', 'Evento de prueba, ¡anímate a participar!','2018-04-28', '2018-04-28', 'Esta actividad no tiene ningún requisito', 'Inovatón', 2);
INSERT INTO public.evento( dtype, descripcion, fin, inicio, requisitos, titulo, creador_id) VALUES ('Actividad', 'Evento de prueba, ¡anímate a participar!','2018-05-01', '2018-05-01', 'Esta actividad no tiene ningún requisito', 'Emprendetón', 2);
INSERT INTO public.evento( dtype, descripcion, fin, inicio, requisitos, titulo, creador_id) VALUES ('Actividad', 'Evento de prueba, ¡anímate a participar!','2018-05-20', '2018-05-20', 'Esta actividad no tiene ningún requisito', 'Emprendetón Vol. 2', 2);
