...
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADNACIONAL',true,'Universidad Los Andes', 'https://administracion.uniandes.edu.co/index.php/es/relaciones-corporativas/centro-de-emprendimiento',true, 'UniversidadAndes.png');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADNACIONAL',true,'Universidad El Bosque', 'http://www.uelbosque.edu.co/egresados/noticia/un-emprendimiento-que-fortalece-u',true, 'UniversidadBosque.png');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADNACIONAL',true,'Universidad Nacional De Colombia', 'http://www.fce.unal.edu.co/directorio-administrativo/unidades-de-apoyo/unidad-de-emprendimiento-e-innovacion.html',true, 'UniversidadNacional.png');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADNACIONAL',true,'Universidad Distrital Francisco José de Caldas', 'http://laud.udistrital.edu.co/noticias/universidad-distrital-le-apuesta-al-emprendimiento',true, 'UniversidadDistrital.png');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADNACIONAL',true,'Universidad Loyola del Pacífico', 'https://ulpgro.mx/alumnos/administracion/102-portal-d-administracion/500-emprendimiento',true, 'UniversidadLoyola.jpg');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADNACIONAL',true,'Universidad del Rosario', 'http://www.urosario.edu.co/Centro-de-Emprendimiento/Inicio/',true, 'UniversidadRosario.jpg');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADNACIONAL',true,'ECCI', 'https://www.ecci.edu.co/es/unidad-de-emprendimiento-192?language_content_entity=es',true, 'Ecci.png');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADNACIONAL',true,'EAN', 'https://universidadean.edu.co/es/facultades/instituto-para-el-emprendimiento-sostenible',true, 'Ean.png');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADNACIONAL',true,'Universidad de Antioquia', 'http://www.udea.edu.co/wps/portal/udea/web/inicio/extension-UdeA/gestion-tecnologica/emprendimiento',true, 'UdeA.png');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADNACIONAL',true,'Universidad Industrial de Santander', 'https://www.uis.edu.co/webUIS/es/investigacionExtension/convocatoriasProgramasApoyo/programasApoyoConvocatoriasInternas/emprendimientoVIE.html',true, 'UniversidadSantander.png');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADNACIONAL',true,'Universidad del Valle', 'http://extension.univalle.edu.co/index.php/programa-emprendedores-univalle',true, 'UniversidadValle.png');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADNACIONAL',true,'Universidad del Norte', 'https://www.uninorte.edu.co/web/centro-de-emprendimiento/concurso-emprende-uninorte',true, 'UniversidadNorte.jpg');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADNACIONAL',true,'Universidad del Cauca', 'http://oportunidadeslaborales.portal.unicauca.edu.co/detallecontenido/idnoticia/10307/',true, 'UniversidadCauca.jpg');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADNACIONAL',true,'Universidad tecnológica de pereira', 'http://blog.utp.edu.co/utpemprendedora/',true, 'UniversidadTecPereira.png');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADNACIONAL',true,'Universidad Pontificia Bolivariana', 'https://www.upb.edu.co/es/investigacion/emprendimiento',true, 'UniversidadBolivariana.png');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADNACIONAL',true,'Universidad Antonio Nariño', 'http://investigacion.uan.edu.co/noticias?option=com_content&view=article&id=94:curso-de-emprendimiento&catid=26:noticias&Itemid=101',true, 'Uan.png');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADNACIONAL',true,'Universidad La Sabana', 'https://www.unisabana.edu.co/empresaysociedad/vision-otri/seis/emprendedores-con-sello-sabana/',true, 'UniSabana.png');

----------------------------------INSERTS UNIVERSIDAD INTERNACIONAL----------------------------------
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADINTERNACIONAL',false,'University of Utah', 'http://eccles.utah.edu/faculty/department-entrepreneurship-strategy/',true, 'UniversityOfUtah.png');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADINTERNACIONAL',false,'University of Bristol', 'http://www.bristol.ac.uk/innovation/entrepreneurship/',true, 'UniversityOfBristol.png');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADINTERNACIONAL',false,'University of Cambridge', 'https://www.jbs.cam.ac.uk/entrepreneurship/',true, 'UniversityOfCambridge.png');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADINTERNACIONAL',false,'University of Miami', 'https://www.bus.miami.edu/academic-programs/undergraduate-business-education/business-curriculum/majors/entrepreneurship/index.html',true, 'UniversityOfMiami.png');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADINTERNACIONAL',false,'University of Pekin', 'http://ostd.pku.edu.cn/Innovation_Entrepreneurship_Education_and_Research/index.htm',true, 'UniversityPekin.png');

INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADINTERNACIONAL',false,'University of Stanford', 'https://www.gsb.stanford.edu/faculty-research/centers-initiatives/ces',true, 'UniversityStanford.png');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADINTERNACIONAL',false,'BabsonCollege', 'http://www.babson.edu/executive-education/expanding-entrepreneurship/Pages/home.aspx',true, 'BabsonCollege.png');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADINTERNACIONAL',false,'Gregoria Tech', 'http://www.gatech.edu/academics/entrepreneurship',true, 'GregoriaTech.png');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADINTERNACIONAL',false,'Harvard University', 'https://www.hbs.edu/mba/the-hbs-difference/Pages/entrepreneurship-and-innovation.aspx',true, 'Harvard.png');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADINTERNACIONAL',false,'University of Oxford', 'https://www.sbs.ox.ac.uk/faculty-research/entrepreneurship',true, 'Oxford.png');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADINTERNACIONAL',false,'MIT', 'http://entrepreneurship.mit.edu/',true, 'MIT.png');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADINTERNACIONAL',false,'Yale University', 'https://som.yale.edu/faculty-research-centers/centers-initiatives/program-on-entrepreneurship',true, 'Yale.png');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADINTERNACIONAL',false,'University of Chicago', 'https://polsky.uchicago.edu/',true, 'UniversityChicago.png');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADINTERNACIONAL',false,'Imperial College Business School', 'https://www.imperial.ac.uk/business-school/programmes/msc-innovation-entrepreneurship-management/',true, 'ImperialCollege.png');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADINTERNACIONAL',false,'University of California Berkeley', 'http://entrepreneurship.berkeley.edu/programs-overview/',true, 'UCBerkeley.png');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADINTERNACIONAL',false,'UCLA', 'http://www.anderson.ucla.edu/centers/price',true, 'UCLA.png');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADINTERNACIONAL',false,'Cornell University', 'http://eship.cornell.edu/',true, 'Cornell.png');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADINTERNACIONAL',false,'University College London', 'https://www.mgmt.ucl.ac.uk/msc-entrepreneurship',true, 'UCL.jpg');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADINTERNACIONAL',false,'University Of Pennsylvania', 'https://entrepreneurship.wharton.upenn.edu/',true, 'Penn.png');
INSERT INTO public.dominio(tipo,nacional,nombre, url, activo, nombre_archivo)VALUES ('UNIVERSIDADINTERNACIONAL',false,'University Of Toronto', 'http://entrepreneurs.utoronto.ca/',true, 'Toronto.png');
